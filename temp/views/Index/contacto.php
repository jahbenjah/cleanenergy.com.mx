...
<head>
    ...
    <title>Contacto &middot; Jousin Palafox Noticias</title>
...
<header>
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            ...
            <div class="col-sm-3 col-md-3 navbar-right hidden">
  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    function cargarMas() {
        $.ajax({
            ...
            type: 'POST',
            data: {de: bloqueNoticias, a: 12, seccion:<?php echo $this->seccion; echo ", sub:".$this->sub; ?>},
            beforeSend:function(){
                //$('#modal-content').html('<div class="modal-body row text-center"><h5>Cargando <i class="fa fa-spinner fa-pulse fa-fw"></i><span class="sr-only">Cargando...</span></h5></div>');
            },
            success:function(msg){
