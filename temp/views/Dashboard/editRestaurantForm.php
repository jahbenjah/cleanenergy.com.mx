<?php $details=$this->dashboard->descPost[0]; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                  ...
                  <div class="row">
                      <div class="col-md-7">
                          <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="inputname" placeholder="<?=$details['name']?>" required autofocus>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="input_address" class="col-sm-2 control-label">Address</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="inputaddress" placeholder="<?=$details['address']?>">
                            </div>
                          </div>
                          <div class="form-group">
        ...
        <div class="modal-content" id="modal-image1-content">
            <div class="">
                ...
                <div class="action">
                    ...
                    <input type="button" class="btn btn-warning btn-sm" id="btnCrop" data-dismiss="modal" value="Terminar Imagen" >
    ...
    <div class="modal-dialog">
        <div class="modal-content" id="modal-image1-content">
            <div class="">
                ...
                <div class="action">
                    <input type="file" id="file" style="width: 250px">
                    <input type="button" class="btn btn-warning btn-sm" id="btnCrop2" data-dismiss="modal" value="Terminar Imagen" >
                    <input type="button" id="btnZoomIn" value="+" >
                    <input type="button" id="btnZoomOut" value="-" >
                </div>
                <div >
    ...
    <div class="modal-dialog">
        <div class="modal-content" id="modal-image1-content">
            <div class="">
                ...
                <div class="action">
                    <input type="file" id="file" style="width: 250px">
                    <input type="button" class="btn btn-warning btn-sm" id="btnCrop3" data-dismiss="modal" value="Terminar Imagen" >
                    <input type="button" id="btnZoomIn" value="+" >
                    <input type="button" id="btnZoomOut" value="-" >
                </div>
                <div >
    ...
    <div class="modal-dialog">
        <div class="modal-content" id="modal-image1-content">
            <div class="">
                ...
                <div class="action">
                    <input type="file" id="file" style="width: 250px">
                    <input type="button" class="btn btn-warning btn-sm" id="btnCrop4" data-dismiss="modal" value="Terminar Imagen" >
                    <input type="button" id="btnZoomIn" value="+" >
                    <input type="button" id="btnZoomOut" value="-" >
                </div>
                <div >
