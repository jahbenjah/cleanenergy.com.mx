<?php 
  $calentadores=$this->calentadores;
?>
<!DOCTYPE html>
<html lang="es">
<head>
            ...
            <div class="p-2 bg-white">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?=$calentadores[0]['categoria'] ?></li>
                  </ol>
                </nav>
                <div class="row">
                   <?php
                    for ($i=0; $i < count($calentadores); $i++) {
                            ...
                            ?>    
                             <div class="col-6 col-md-6 col-lg-3 mb-1">
                                <div class="card">
                                    <a href="<?=URL.'calentadores/producto/'.$calentadores[$i]['id'].'/'.str_replace(" ", '-', html_entity_decode($calentadores[$i]['nombre']))?>"><img class="card-img-top" src="<?=URL?>public/img/<?=html_entity_decode($calentadores[$i]['image'])?>" alt="Card image cap"></a>
                                    <div class="card-body">
                                        <h5 class="card-title"><a style="color: black;text-decoration: none;font-weight: 100;" href="<?=URL.'calentadores/producto/'.$calentadores[$i]['id'].'/'.str_replace(" ", '-', html_entity_decode($calentadores[$i]['nombre']))?>" title="Ver Producto"><?=html_entity_decode($calentadores[$i]['nombre'])?></a></h5>
                                        <p class="mb-0 pb-0 text-muted">Fabricante: <span class="text-energy"><?=html_entity_decode($calentadores[$i]['fabricante'])?></p></span>
                                        <p class="mb-0 pb-0 text-muted">Categoría: <span class="text-clean"><?=html_entity_decode($calentadores[$i]['categoria'])?></span></p>
