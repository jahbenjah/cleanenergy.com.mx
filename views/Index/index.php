  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container d-flex">
      ...
      <div class="social-links">
        ...
        <a href="<?= URL ?>en/index"><img src="<?= URL ?>/public/img/us.png" alt="clean energy us"></a>
      </div>
    </div>
  </section>
  ...
  <section id="hero">
    <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url(/public/img/bannerpagina.png);">
        ...
        <!-- Slide 3 -->
        <div class="carousel-item" style="background-image: url(/public/img/maxresdefault.jpg);">
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              <h2 class="text-center"><span>Somos El Centro de Distribución Solar más completo de México</span></h2>
