  ...
  <!--section id="topbar" class="d-none d-lg-block">
    <div class="container d-flex">
      <div class="contact-info mr-auto">
        <i class="icofont-envelope"></i><a href="contacto@cleanenergy.com.mx">contacto@cleanenergy.com.mx
        </a>
  ...
  <header id="header">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="index.html"><a href="index.html"><img src="\assets\img\logocleanenergy.jpeg" alt="" class="img-fluid"></a></h1>
  ...
  <section id="hero">
    <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 2 -->
        <!--div class="carousel-item" style="background-image: url(assets/img/paneles-solares-fotovoltaicos.jpg);">
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              <h2 class="text-center">¿Que hacemos?</h2>
              <p class="text-center">Ofrecemos la más amplia variedad de sistemas Fotovoltaicos y térmicos. 
        ...
        <!-- Slide 3 -->
        <!--div class="carousel-item" style="background-image: url(assets/img/panelessolaresft.jpg);">
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              <h2 class="text-center">Tenemos los mejores productos</h2>
              <p class="text-center">En CLEAN ENERGY sólo distribuimos productos de la más alta calidad, contamos con las mejores marcas del mercado a un precio accesible. Podrás encontrar todo tipo de productos solares, desde Paneles y Calentadores hasta Inversores y Controladores para plantas solares.</p>
              <div class="text-center"><a href="" class="btn-get-started">Cotiza Ahora!</a></div>
            </div>
          </div>
        </div -->
