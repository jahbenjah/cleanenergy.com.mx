  ...
  <body>
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
      ...
      <nav class="my-2 my-md-0 mr-md-3">
        ...
        <span class="border-bottom"><a class="p-2  text-info" href="<?=URL?>dashboard/autonomos">Autonomos</a></span> 
        ...
        <form class="form-horizontal w-100" id="businessUpdate" method="post" accept-charset="utf-8" role="form" enctype="multipart/form-data">
           <div class="row">
              <div class="col-md-3 form-actions">
                  ...
                  <div class="mt-2">
                    <a href="<?=URL?>dashboard/autonomos" class="btn btn-link text-dark "><u>Volver</u></a>
                  </div>
                    ...
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-10">
                        <select name="inputcategoria" class="form-control">
                          <option value="Paneles Autonomos" <?= ($business['categoria']=='Paneles Autonomos') ? "selected" : "" ; ?> >Paneles Autonomos</option>
                          <option value="Inversores de Plantas Solares" <?= ($business['categoria']=='Inversores de Plantas Solares') ? "selected" : "" ; ?> >Inversores de Plantas Solares</option>
                          <option value="Controladores" <?= ($business['categoria']=='Controladores') ? "selected" : "" ; ?> >Controladores</option>
                          <option value="Baterias" <?= ($business['categoria']=='Baterias') ? "selected" : "" ; ?> >Baterias</option>
                          <option value="Bombas" <?= ($business['categoria']=='Bombas') ? "selected" : "" ; ?> >Bombas</option>
                          <option value="Luminaria Solar" <?= ($business['categoria']=='Luminaria Solar') ? "selected" : "" ; ?> >Luminaria Solar</option>
                          <option value="Refrigeradores" <?= ($business['categoria']=='Refrigeradores') ? "selected" : "" ; ?> >Refrigeradores</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        $("#businessUpdate").validate({
          ...
          function updatingBusinessForm(){
            ...
            $.ajax({
            url: "<?=URL?>dashboard/updatingAutonomos",
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
