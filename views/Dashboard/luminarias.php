  ...
  <body>
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
      ...
      <nav class="my-2 my-md-0 mr-md-3">
        ...
        <span class="border-bottom"><a class="p-2  text-info" href="<?=URL?>dashboard/luminarias">Luminarias</a></span> 
    ...
    <div class="container">
      <div class="row"><span class="border-right">
        <div class="col-md-3">
          <a href="<?=URL?>dashboard/addProductLuminarias" class="btn btn-outline-info"><i class="fa fa-plus pr-1 text-info"></i> Agregar Producto</a>
        </div>
        </span>
        <div class="col-md-9">
              ...
              <table class="table table-striped table-sm">
                ...
                <?php
                    for ($i=0; $i < count($luminarias); $i++) { 
                      $linka= URL.'dashboard/editProductLuminarias/'.$luminarias[$i]["id"];
                      $linka.="/".str_replace(" ", '-', html_entity_decode($luminarias[$i]['nombre']));
                        echo "
                            <tr>
                              <td id='nombre-".$luminarias[$i]['id']."' ><a href='$linka' class='text-info'>".$luminarias[$i]['nombre']."</a></td>
                               <td>".$luminarias[$i]['categoria']."</td>
                               <td>".$luminarias[$i]['fabricante']."</td>
                               <td>".'<button type="button" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#modal-business" onclick="delBusinessTEMP('.$luminarias[$i]['id'].')"><i class="fa fa-trash"></i></button>'."</td>
                              <td></td>
