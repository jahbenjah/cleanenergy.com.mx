                    ...
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-10">
                        <select name="inputcategoria" class="form-control">
                          <option value="Paneles Autonomos" >Paneles Autonomos</option>
                          <option value="Inversores de Plantas Solares" >Inversores de Plantas Solares</option>
                          <option value="Controladores" >Controladores</option>
                          <option value="Baterias"  >Baterias</option>
                          <option value="Bombas"  >Bombas</option>
                          <option value="Luminaria Solar"  >Luminaria Solar</option>
      ...
      $(document).ready(function() {
        ...
        $("#addBusiness").validate({
            ...
            function addPost(){
              ...
              $.ajax({           
                  url: "<?=URL?>dashboard/addingProductAutonomos",
                  type: 'POST',
                  data: formData,
