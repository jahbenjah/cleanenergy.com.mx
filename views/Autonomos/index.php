          ...
          <div class="col-md-8">
            <div class="p-2 bg-white">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?=URL?>autonomos" class="text-clean">Autónomos</a></li>
                    ...
                    for ($i=0; $i < count($autonomos); $i++) {
                            ...
                            ?>    
                             <div class="col-6 col-md-6 col-lg-4 mb-1">
                                <div class="card">
                                    <a href="<?=URL.'autonomos/producto/'.$autonomos[$i]['id'].'/'.str_replace(" ", '-', html_entity_decode($autonomos[$i]['nombre']))?>"><img class="card-img-top" src="<?=URL?>public/img/<?=html_entity_decode($autonomos[$i]['image'])?>" alt="Card image cap"></a>
                                    <div class="card-body">
                                        <h5 class="card-title"><a style="color: black;text-decoration: none;font-weight: 100;" href="<?=URL.'autonomos/producto/'.$autonomos[$i]['id'].'/'.str_replace(" ", '-', html_entity_decode($autonomos[$i]['nombre']))?>" title="Ver Producto"><?=html_entity_decode($autonomos[$i]['nombre'])?></a></h5>
                                        <p class="mb-0 pb-0 text-muted">Fabricante: <span class="text-energy"><?=html_entity_decode($autonomos[$i]['fabricante'])?></p></span>
                                        <p class="mb-0 pb-0 text-muted">Categoría: <span class="text-clean"><?=html_entity_decode($autonomos[$i]['categoria'])?></span></p>
