...
<body>
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container d-flex">
      ...
      <div class="social-links">
        ...
        <a href="<?= URL ?>contacto"><img src="<?= URL ?>/public/img/mx.png" alt="clean energy us"></a>
      </div>
    </div>
  </section>
  ...
  <header id="header">
    <div class="container d-flex">
      ...
      <a href="en/index"><img src="<?= URL ?>/public/img/logo.png" alt="" class="img-fluid"></a>        
      </div>
            ...
            <div class="info-wrap">
              ...
              22710 Rosarito, B.C.</p>  
                ...
                <div class="col-lg-4 info mt-4 mt-lg-0">
                  ...
                  <h4>Email:</h4>
                  <a href="mailto:contacto@cleanenergy.com.mx"> contacto@cleanenergy.com.mx</a><br><a href="mailto:emarin@cleanenergy.com.mx"> emarin@cleanenergy.com.mx</a>
                </div>
                <div class="col-lg-4 info mt-4 mt-lg-0">
