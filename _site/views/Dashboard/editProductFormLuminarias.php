        ...
        <form class="form-horizontal w-100" id="businessUpdate" method="post" accept-charset="utf-8" role="form" enctype="multipart/form-data">
           <div class="row">
              <div class="col-md-3 form-actions">
                  ...
                  <div class="mt-2">
                    <a href="<?=URL?>dashboard/luminarias" class="btn btn-link text-dark "><u>Volver</u></a>
                  </div>
                    ...
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-10">
                        <select name="inputcategoria" class="form-control">
                           <option value="Luminarias" <?= ($business['categoria']=='Luminarias') ? "selected" : "" ; ?> >Luminarias</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        $("#businessUpdate").validate({
          ...
          function updatingBusinessForm(){
            ...
            $.ajax({
            url: "<?=URL?>dashboard/updatingLuminarias",
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
