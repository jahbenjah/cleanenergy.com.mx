          ...
          <div class="album py-5 bg-light">
                <form class="form-horizontal" id="addNewUserForm">
                    <div class="row">
                        ...
                        <div class="col-2"></div>
                        <div class="col-3 pl-5" style="box-shadow: inset 1px 0 0 rgba(0, 0, 0, .1);">
                          <div class="form-actions">
                            <div id="statusUserForm"></div>
                            <div class=" ">
                                <button type="submit" class="btn btn-lg btn-primary" id="btnAddUser"><i class="fa fa-plus pr-1 text-white"></i> Agregar Usuario</button>
                                <div class="mt-1">
