<?php
  ...
  if (!is_numeric(array_search(6, $permissions))) {
      ...
      <div class="row">
        ...
        <div class="col-md-10"> 
            <div class="page-header">
              <a href="<?=URL?>dashboard/addNoticia/6" class="btn btn-therapists btn-lg"><i class="fa fa-newspaper-o" aria-hidden="true" ></i> Agregar Noticia saber</a>
            </div>
