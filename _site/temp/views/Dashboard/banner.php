...
<html lang="en">
      ...
      <div class="row">
        <div class="col-md-2">
            <div class="">
                <div class="row col-md-12">
                    ...
                    <a href="<?=URL?>dashboard/nutricion/"  <?= (!is_numeric(array_search(8, $permissions))) ? "class='hidden'" : "" ?>>
                        <div class="tile tile-green col-xs-12"  >
                           <div class="tile-content">
                            <div class="tile-icon-large">
                              <i class="fa fa-leaf" aria-hidden="true"></i>
                            </div>
                           </div>
                          <span class="tile-label">Nutrición</span>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-10"> 
            <div class="page-header">
              <a href="#" class="btn btn-therapists btn-lg hidden" onclick="addBannerform()"><i class="fa fa-picture-o" aria-hidden="true" ></i> Agregar Banner</a>
            </div>
            <div class="row">
              <div class="col-sm-3" style="border: solid 1px #CCC">
                  <h2 class="text-center">Banner Principal</h2>
                <div class="">
                  <a href="#" class="thumbnail" onclick="updateBanner(<?=$rows[3]['id']?>)">        
                    <img src="<?=URL?>public/img/banners/<?=$rows[3]['img']?>" alt="">
              ...
              <div class="col-sm-12 col-md-9" style="border: solid 1px #CCC">
                  <h2 class="text-center">Carousel</h2>
                <div class="col-xs-12 col-sm-3 col-md-4 col-lg-4">
                  <a href="#" class="thumbnail" onclick="updateBanner(<?=$rows[2]['id']?>)">        
                    <img src="<?=URL?>public/img/banners/<?=$rows[2]['img']?>" alt="">
                    <button class="btn btn-block btn-info">Editar</button> 
                  </a>
                  <div class="thumbnail">
                    <img src="<?=URL?>public/img/banner-detalle-noticia-slide.jpg" alt="">
                  </div>
                </div>
                <div class="col-xs-12 col-sm-3 col-md-4 col-lg-4">
                  <a href="#" class="thumbnail" onclick="updateBanner(<?=$rows[1]['id']?>)">        
                    <img src="<?=URL?>public/img/banners/<?=$rows[1]['img']?>" alt="">
                    <button class="btn btn-block btn-info">Editar</button> 
                  </a>
                  <div class="thumbnail">
                    <img src="<?=URL?>public/img/banner-detalle-noticia-slide.jpg" alt="">
                ...
                <div class="col-xs-12 col-sm-3 col-md-4 col-lg-4">
                  <a href="#" class="thumbnail" onclick="updateBanner(<?=$rows[0]['id']?>)">        
                    <img src="<?=URL?>public/img/banners/<?=$rows[0]['img']?>" alt="">
                    <button class="btn btn-block btn-info">Editar</button> 
                  </a>
                  <div class="thumbnail">
                    <img src="<?=URL?>public/img/banner-detalle-noticia-slide.jpg" alt="">
  ...
  <script>
    ...
    function  updateBanner(e) {
      ...
      $.ajax({
        url: '<?=URL?>dashboard/updateBannerForm',
        type: 'POST',
        data: {id: e},
        beforeSend: function() {
          $('#modal-content-post').html('<p class="text-center">Cargando <i class="fa fa-spinner fa-pulse fa-fw"></i><span class="sr-only">Cargando...</span>...</p>');
    ...
    function delBanner(id){
      $('#modal-post').modal({
        ...
        backdrop: false
            ...
            $('#modal-content-post').html('<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title">Eliminar Banner</h4></div><div class="modal-body">Seguro que deseas eliminar el banner: <strong>'+nombre+'</strong></div><div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button><button type="button" class="btn btn-danger" onclick="confirmaElimina('+id+')">Eliminar</button></div>');            
        }
    function confirmaElimina(id) {
      $.ajax({
          url: '<?=URL?>dashboard/delBanner',
          type: 'POST',
          data:{id: id},
          beforeSend:function(){
