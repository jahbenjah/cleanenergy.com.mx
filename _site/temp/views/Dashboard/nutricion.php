    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10"> 
            ...
            <a href="<?=URL?>dashboard/addNoticia/8" class="btn btn-therapists btn-lg" ><i class="fa fa-newspaper-o" aria-hidden="true" ></i> Agregar Noticia Nutrición</a>
                    ...
                    for ($i=0; $i < count($rows); $i++) { 
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?=URL?>dashboard/updateNoticia/8-<?=$rows[$i]['id']?>" class="btn btn-info"  ><i class="fa fa-pencil"></i></a>
