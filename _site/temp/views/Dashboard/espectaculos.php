<?php
  ...
  if (!is_numeric(array_search(3, $permissions))) {
      ...
      <div class="row">
        ...
        <div class="col-md-10"> 
            <div class="page-header">
              <a href="<?=URL?>dashboard/addNoticia/3" class="btn btn-therapists btn-lg"><i class="fa fa-newspaper-o" aria-hidden="true" ></i> Agregar Noticia Espectaculos</a>
            </div>
                    ...
                    for ($i=0; $i < count($rows); $i++) { 
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?=URL?>dashboard/updateNoticia/3-<?=$rows[$i]['id']?>" class="btn btn-info"  ><i class="fa fa-pencil"></i></a>
